...
<div class="card-body">
<div style="font-size: 30px; color: black;">الذكر قبل الوضوء</div>
<br>
<p class="card-text" style="text-align: center; font-size: 29px;" ><span>"</span>قبل الوضوء: "بِسْمِ ٱللّٰهِ 
</p>
<hr>
...
<div class="card text-white" style="background-color: white; color: black;  border-radius: 25px;">
<div class="card-body">
<div style="font-size: 30px; color: black;">الذكر بعد الوضوء</div>
<br>
<p class="card-text" style="text-align: center; font-size: 29px;" >أشْهَدُ أن لا إله إلا الله وحْدَهُ لا شريكَ لهُ ، وأشْهَدُ أنَّ محمداً عَبدُهُ ورسُولُه.
