...
<div class="card-body">
<div style="font-size: 30px; color: black;">الذكر عند الخلاء</div>
<br>
<p class="card-text" style="text-align: center; font-size: 29px;" >(بِسْمِ الله) اللّهُـمَّ إِنِّـي أَعـوذُ بِـكَ مِـنَ الْخُـبْثِ وَالْخَبائِث
</p>
<hr>
...
<div class="card text-white" style="background-color: white; color: black;  border-radius: 25px;">
<div class="card-body">
<div style="font-size: 30px; color: black;">الذكر بعد الخروج من الخلاء</div>
<br>
<p class="card-text" style="text-align: center; font-size: 29px;" >غُفْـرانَك
</p>
<hr>
<div style="font-size: 19px; color: black;">تقال مره واحده</div>
</div>
