...
window.location.href='<?php echo $_SERVER['HTTP_REFERER']; ?>'">
  ...
  <form method="post" action="register.php">
	...
	<input type="text" class="form-control" id="email" value="<?php echo $username; ?>" spellcheck="false" autocomplete="off" placeholder="Enter Username" name="username">
	</div>
	<div class="form-group">
	<input type="text" class="form-control" id="pwd" spellcheck="false" name="email" value="<?php echo $email; ?>" autocomplete="off" placeholder="Email Address" >
	</div>
	<div class="form-group">
	<input type="password" class="form-control" id="pwd" spellcheck="false" name="password_1"  autocomplete="off" placeholder="Write a Password" >
	</div>
	<div class="form-group">
	<input type="password" class="form-control" id="pwd" spellcheck="false" name="password_2"  autocomplete="off" placeholder="Confirm The Password" >
	</div>
	...
	<br>
	<center>
	<input type="submit" class="btn btn-default" name="reg_user" value="Sign up">
	</form>
	<div onclick="this.onclick=null; move() , 
window.location.href='login.php'"   class="btn btn-default">Login</div>
	</center>
	</div>
